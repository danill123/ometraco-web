...
<div class="container my-3">
    ...
    <div class="row">
        ...
        <div class="col-12 col-md-8 mt-3">
            ...
            <!-- <div class="card p-3 description" style="box-shadow: 0px 2px 6px 2px rgba(0, 0, 0, 0.15);">
                <?= $description ?>
            </div> -->
        </div>
        <style>
        ...
        <div class="col-12 col-md-12">
            <h5 class="mt-4 item-title">Deskripsi</h5>
                        ...
                        <a href="<?= base_url("product?id=" . esc($item->id)) ?>" class="product-item col-6 col-md-2 mt-2">
                            <div class="mb-1 mt-1" style="border-radius: 10px; box-shadow: 0px 1px 3px 1px rgba(0, 0, 0, 0.15);">
                                ...
                                <div class="p-1 px-2">
                                    ...
                                    <div class="text-center py-1 px-3 mb-1" style="font-weight: 600; background: linear-gradient(156deg, #F0F0F0 0%, #8A8A8A 100%); border-radius: 5px;">Hubungi Kami</div>
                                </div>
                            </div>
                        </a>
                    <?php } ?>
